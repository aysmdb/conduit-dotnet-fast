...
namespace RealDotnetFast.Migrations
{
    ...
    [Migration("20250225124721_follower")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealDotnetFast.Models.Entities.UserFollower", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("RealDotnetFast.Models.Entities.UserFollowing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_user_following_user_id");
            ...
            modelBuilder.Entity("RealDotnetFast.Models.Entities.UserFollower", b =>
                {
                    b.HasOne("RealDotnetFast.Models.Entities.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_follower_users_user_id");
                });
            ...
            modelBuilder.Entity("RealDotnetFast.Models.Entities.UserFollowing", b =>
                {
                    b.HasOne("RealDotnetFast.Models.Entities.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_following_users_user_id");
                });
